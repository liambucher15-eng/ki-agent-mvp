// Deine zwei Supabase-Werte (Supabase -> Project Settings -> API).
// BEIDE sind öffentlich und fürs Frontend gedacht — der anon-Key ist KEIN Geheimnis.
// NIEMALS den "service_role"-Key hier eintragen (der ist geheim, wie ein Passwort).
//
