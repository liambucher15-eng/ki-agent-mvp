// Deutsche Oberflaechen-Texte fuer Clerk (Anmelden, Konto erstellen, Fehler).
//
// Herkunft: @clerk/localizations v4, Datei dist/de-DE.js, unveraendert bis auf
// die Verpackung: Der CommonJS-Export ist durch "window.CLERK_DE = deDE"
// ersetzt, damit die Datei als normales <script> laedt.
//
// LOKAL abgelegt statt vom CDN geladen — aus demselben Grund wie GSAP: Das
// Onboarding ist der Trichter, durch den die zahlenden Kunden gehen, und darf
// nicht an einer fremden Domain haengen. lib/auth.js prueft window.CLERK_DE ab;
// fehlt die Datei, laeuft Clerk eben auf Englisch weiter statt gar nicht.
//
// Beim Aktualisieren: Datei neu ziehen von
//   https://cdn.jsdelivr.net/npm/@clerk/localizations@4/dist/de-DE.js
// und dieselben zwei Ersetzungen wieder anwenden.
